...
par(mfrow=c(2,2))
with(subsetPowerConsumptionData, plot(dateTime, Global_active_power, type="l", xlab="", ylab="Global Active Power"))
with(subsetPowerConsumptionData, plot(dateTime, Voltage, type = "l", xlab="datetime", ylab="Voltage"))
with(subsetPowerConsumptionData, plot(dateTime, Sub_metering_1, type="l", xlab="", ylab="Energy sub metering"))
...
with(subsetPowerConsumptionData, plot(dateTime, Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power"))
dev.off()
